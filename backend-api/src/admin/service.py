...
async def raw_text_upload_to_vdb(self, source: str, information: str, request: Request) -> None:
    ...
    upload_to_vector_db(prepare_embedding_input_from_preformatted(input_raw_text, state.rag.embedder), state.rag.qdrant_client)
