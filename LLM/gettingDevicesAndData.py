...
async def get_devices_info(hasIfsEqual = False, ifEqualKey = None, ifEqualKeyValue = None, hasIfsIn = False, ifInKey = None, ifInKeyValue = None):
    ...
    for device in devices:
        if hasIfsEqual:
            ...
            if (ifEqualKeyValue in ["True", "true"] ):
                ifEqualKeyValue = True
            elif (ifEqualKeyValue in ["False", "false"]):
...
#deviceInfo = get_devices_info_by_params(hasIfsIn=True, ifInKey="deviceName", ifInKeyValue="OXYGEN")from onc import ONC