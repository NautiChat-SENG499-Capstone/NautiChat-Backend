...
async def generate_download_codes(
    ...
    dateFrom: str = None,
    dateTo: str = None,
    dpo_qualityControl: int = 1,
    dpo_dataGaps: int = 1,
    dpo_resample: str = "none",
    dpo_minMax: int = None,
    dpo_average: int = None,
    dpo_minMaxAvg: int = None,
    ...
    dpo_qualityControl = sync_param(
        "dpo_qualityControl", dpo_qualityControl, obtainedParams
    )
    dpo_dataGaps = sync_param("dpo_dataGaps", dpo_dataGaps, obtainedParams)
    dpo_resample = sync_param("dpo_resample", dpo_resample, obtainedParams)
    dpo_minMax = sync_param("dpo_minMax", dpo_minMax, obtainedParams)
    dpo_average = sync_param("dpo_average", dpo_average, obtainedParams)
    dpo_minMaxAvg = sync_param("dpo_minMaxAvg", dpo_minMaxAvg, obtainedParams)
    """
    ...
    allParams = {
        ...
        "dpo_average": dpo_average,
        "dpo_dataGaps": dpo_dataGaps,
        "dpo_minMax": dpo_minMax,
        "dpo_minMaxAvg": dpo_minMaxAvg,
        "dpo_qualityControl": dpo_qualityControl,
        "dpo_resample": dpo_resample,
    }
    # neededParams = []
    # obtainedParams = {}
    ...
    obtainedParams = {
        param: value for param, value in allParams.items() if value is not None
    }  # List of all parameters that are set.
    print(f"Obtained parameters: {obtainedParams}")
    ...
    try:
        response = onc.requestDataProduct(obtainedParams)
